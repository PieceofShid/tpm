  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('level.add')}}" class="btn btn-primary">Tambah</a>
      </div>
    </div>
  </div>
  @php
          ...
          <tbody>
            @foreach ($levels as $level)
              <tr>
                ...
                <td>{{$level->name}}</td>
                <td>
                  <a href="{{ route('level.edit', $level->id)}}" class="btn btn-sm text-warning"><i class="ti-pencil"></i></a>
                  <button class="btn btn-sm text-danger" onclick="hapus('{{$level->id}}')"><i class="ti-trash"></i></button>
                </td>
              </tr>
            @endforeach
          </tbody>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="Labelmodal">Hapus Level</h5>
